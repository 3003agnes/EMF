/**
 */
package emf.Ressource.provider;
...
/**
 * This is the item provider adapter for a {@link emf.Ressource.Ressource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RessourceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ressource_typ_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ressource_typ_feature", "_UI_Ressource_type"),
				 RessourcePackage.Literals.RESSOURCE__TYP,
				 true,
				 false,
				 false,
	...
	protected void addAnzahlPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ressource_anzahl_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ressource_anzahl_feature", "_UI_Ressource_type"),
				 RessourcePackage.Literals.RESSOURCE__ANZAHL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		RessourcenEnum labelValue = ((Ressource)object).getTyp();
